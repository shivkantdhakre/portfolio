  ...
  return (
    <section id="chapter-contact" className="relative w-full py-24 px-4 sm:px-8 max-w-7xl mx-auto z-10">
      ...
      <ChapterTransition
        number="07"
        title="LET'S BUILD"
        subtitle="COMMUNICATION CONSOLE & DIRECT DISPATCH"
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <FadeIn direction="left" distance={24} className="lg:col-span-6 space-y-6">
          <div className="space-y-3">
            <ChapterHeading chapter="07" telemetry="DISPATCH_LINK // DIRECT_CONNECT">
              Ready To Build <br />
            ...
            <p className="text-gray-300 text-sm sm:text-base leading-relaxed font-sans pt-2">
              ...
              enterprise mobile system that cannot afford to drop sessions in production — let&apos;s connect.
            </p>
          </div>
          ...
          <div className="flex flex-wrap gap-4 pt-4">
            <MagneticButton strength={0.25}>
              <a
                ...
                className="px-6 py-3.5 rounded-lg bg-orange-500 hover:bg-orange-400 text-black font-mono font-bold text-xs flex items-center gap-2 transition-all shadow-lg shadow-orange-500/25 tracking-wider whitespace-nowrap focus-ring-orange"
              >
            ...
            <MagneticButton strength={0.2} onClick={onOpenRecruiter}>
              <div 
                onMouseEnter={() => sound.playHover()}
                className="px-6 py-3.5 rounded-lg bg-white/10 hover:bg-white/15 border border-white/20 text-white font-mono font-bold text-xs flex items-center gap-2 transition-all cursor-pointer tracking-wider whitespace-nowrap focus-ring-cyan"
              >
            ...
            <div className="space-y-3">
              ...
              <div className="p-3.5 rounded-lg bg-white/[0.03] border border-white/10 flex items-center justify-between group hover:border-amber-500/50 transition-colors">
                ...
                <button
                  onClick={copyEmail}
                  onMouseEnter={() => sound.playHover()}
                  className="px-3 py-1.5 rounded bg-white/5 hover:bg-white/10 text-gray-300 hover:text-white text-[11px] flex items-center gap-1.5 transition-colors cursor-pointer focus-ring-amber"
                >
                  {copiedEmail ? (
                    <>
              ...
              <div className="p-3.5 rounded-lg bg-white/[0.03] border border-white/10 flex items-center justify-between group hover:border-cyan-500/50 transition-colors">
                ...
                <button
                  onClick={copyPhone}
                  onMouseEnter={() => sound.playHover()}
                  className="px-3 py-1.5 rounded bg-white/5 hover:bg-white/10 text-gray-300 hover:text-white text-[11px] flex items-center gap-1.5 transition-colors cursor-pointer focus-ring-cyan"
                >
                  {copiedPhone ? (
                    <>
                      <Check className="w-3 h-3 text-emerald-400" />
              ...
              <div className="p-3.5 rounded-lg bg-white/[0.03] border border-white/10 flex items-center justify-between group hover:border-emerald-500/50 transition-colors">
                ...
                <a
                  ...
                  onMouseEnter={() => sound.playHover()}
                  onClick={() => sound.playClick()}
                  className="px-3 py-1.5 rounded bg-emerald-500/20 hover:bg-emerald-500/30 text-emerald-300 text-[11px] flex items-center gap-1.5 border border-emerald-500/40 transition-colors focus-ring-emerald"
                >
            ...
            <div className="pt-2 flex items-center gap-3">
              <MagneticButton strength={0.1} className="flex-1">
                <a
                  ...
                  onMouseEnter={() => sound.playHover()}
                  className="w-full p-2.5 rounded bg-white/5 hover:bg-white/10 border border-white/10 flex items-center justify-center gap-2 text-xs text-gray-300 hover:text-white transition-colors focus-ring-cyan"
                >
              ...
              <MagneticButton strength={0.1} className="flex-1">
                <a
                  ...
                  rel="noopener noreferrer"
                  onMouseEnter={() => sound.playHover()}
                  className="w-full p-2.5 rounded bg-white/5 hover:bg-white/10 border border-white/10 flex items-center justify-center gap-2 text-xs text-gray-300 hover:text-white transition-colors focus-ring-amber"
                >
